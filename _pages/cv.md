...
*   **K2 Risk (Reasoning Layer for Multi-Asset Risk)**
    ...
    *   Orchestrated LLM workflows to interpret high-dimensional risk analytics, generating structured narratives and "why-chains" that articulate potential market drivers beyond numerical exposures.
